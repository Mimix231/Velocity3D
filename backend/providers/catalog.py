...
MODEL_CATALOG: tuple[CatalogEntry, ...] = (
    ...
    CatalogEntry(
        ...
        description="Recommended image provider for this app. Uses Hunyuan 2.1 shape generation and a Velocity3D-owned Hunyuan3D-Paint PBR runtime when AI textures are enabled.",
        selection_modes=("image",),
        library_modes=("image",),
        recommended=True,
        ...
        platform_note="The paint path requires compiled Velocity3D runtime copies of the CUDA rasterizer and mesh inpaint processor built with CUDA Toolkit 13.0 to match torch+cu130.",
        install_steps=(
            ...
            "Velocity3D materializes BASE_DIR\\Runtimes\\hunyuan3d-2.1-paint and executes that private runtime instead of running hy3dpaint directly from the downloaded repository.",
        ),
